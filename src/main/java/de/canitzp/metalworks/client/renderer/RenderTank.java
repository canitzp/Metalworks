...
import de.canitzp.metalworks.machine.tank.TileTank;
...
public class RenderTank extends TileEntitySpecialRenderer<TileTank> {
    ...
    public void render(TileTank tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if(tank.getFluid() != null){
            ...
            double i = (tank.getCapacity() - fluidStack.amount) * 14 / (tank.getCapacity()*1D);
            ...
            Util.drawModalRectWithCustomSizedTexture(0, 0, 0, heightStep, 14, 14 - i, 16, texHeight);
            ...
            Util.drawModalRectWithCustomSizedTexture(0, 0, 0, heightStep, 14, 14, 16, texHeight);
            GlStateManager.popMatrix();
