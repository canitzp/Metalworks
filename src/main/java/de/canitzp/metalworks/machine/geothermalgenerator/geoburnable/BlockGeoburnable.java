package de.canitzp.metalworks.machine.geothermalgenerator.geoburnable;
...
public class BlockGeoburnable extends DefaultGeoBurnable {
    ...
    public BlockGeoburnable(IBlockState state, int burnTime, int energy){
        ...
        this.setRegistryName(new ResourceLocation(Metalworks.MODID, "geoburnable." + stateLoc.getResourceDomain() + "." + stateLoc.getResourcePath()));
    }
