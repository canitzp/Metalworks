package de.canitzp.simplesteel.client.gui;
...
public class GuiEnergyBar extends Gui{
    ...
    public static final ResourceLocation LOCATION = new ResourceLocation(SimpleSteel.MODID, "textures/gui/energy_bar.png");
